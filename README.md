...
* [Http-Proxy](https://github.com/vapory-mining/vapory-http-proxy) HTTP proxy with web interface
* [Stratum Proxy](https://github.com/vapory-mining/vapory-stratum-proxy) for Vapory
